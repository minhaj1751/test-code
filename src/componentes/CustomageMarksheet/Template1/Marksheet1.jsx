                ...
                >
                    ...
                    <div className="flex gap-x-3">
                        ...
                        <div className="text-center mt-0 pt-0 flex-1">
                            ...
                            <p>{data?.institute_established}</p>
                    ...
                    {/* Student Info */}
                    <div className={`flex ${photoSide === "left" ? "flex-row-reverse" : ""} gap-2 mt-4`}>
                        ...
                        {/* Student Photo ( functional) */}
                        <div
                            className={cx(
                                "h-[120px] w-[120px] overflow-hidden border border-black",
                                photoShape === "round" ? "rounded-full" : "rounded-none"
                            )}
                        >
                            <img
